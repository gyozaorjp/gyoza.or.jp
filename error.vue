...
<template>
    ...
    <main class="pt-12 bg-[url('/img/top/contact_bg@pc.jpg')] bg-cover bg-center">
      <section class="py-64 bg-black/20 backdrop-blur flex flex-col justify-center items-center gap-y-2">
